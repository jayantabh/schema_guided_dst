...
class SchemaGuidedDST(object):
    ...
    def _encode_utterances(self, features, is_training, task=None, slot_idx=None):
...
def main(_):
    ...
    if (not tf.io.gfile.exists(schema_embedding_file) or
        ...
        schema = _create_schema_embeddings(bert_config, schema_embedding_file)
