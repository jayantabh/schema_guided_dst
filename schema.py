...
class ServiceSchema(object):
    ...
    def __init__(self, schema_json, service_id=None):
        ...
        self._intent_descs = sorted(i["description"] for i in schema_json["intents"])
        self._slots = sorted(s["name"] for s in schema_json["slots"])
        self._slot_descs = sorted(s["description"] for s in schema_json["slots"])
    ...
    @property
    def intent_descs(self):
        return self._intent_descs

    @property
    def slot_desc(self):
        return self._slot_descs
